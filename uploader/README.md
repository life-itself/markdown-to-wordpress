...
Use `upload.js media` to push local images to WordPress before wiring their URLs into Markdown posts:
...
2.  **Run the media uploader**:
    ```sh
    node upload.js media path/to/image.png another/folder/
    ```
